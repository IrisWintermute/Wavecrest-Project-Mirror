...
STACK_EXISTS=$(aws cloudformation describe-stack-instance --stack-set-name "$STACK_NAME" --stack-instance-account "$ACCOUNT_ID" --stack-instance-region "$REIGON" --output text) || ""
echo "$STACK_EXISTS"
